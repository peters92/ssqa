...
parser.add_argument('--data_path', type=str, default="../../SQuAD-v1.1.json",
                    help='Location of SQuAD dataset.')
parser.add_argument('--data_dest', type=str, default="../../data/SQuADv1.1",
                    help='Desired location of output.')
...
for sample in data:
    ...
    if n % 10 == 0:  # print progress
        sys.stdout.write("\rParsing dataset into separate files...{} done out of {}\n".format(n, N))
    n += 1
